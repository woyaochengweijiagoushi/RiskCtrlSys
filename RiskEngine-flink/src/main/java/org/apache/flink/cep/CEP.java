...
public class CEP {
    ...
    /**
     * author: Juege
     * description: 第1个自定义方法
     * @param input:
     * @param dynamicPattern:
     * @return org.apache.flink.cep.PatternStream<T>
     */
    public static <T> PatternStream<T> juegePatternStream(
            DataStream<T> input, DynamicPattern<T> dynamicPattern) {
        return new PatternStream<>(input, dynamicPattern);
    }
