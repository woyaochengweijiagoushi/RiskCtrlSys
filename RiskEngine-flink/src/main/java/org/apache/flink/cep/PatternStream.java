...
public class PatternStream<T> {
    ...
    /**
     * author: Juege
     * description: 第2个自定义方法
     * @param inputStream:
     * @param dynamicPattern:
     * @return null
     */
    PatternStream(final DataStream<T> inputStream, final DynamicPattern<T> dynamicPattern) {
        this(PatternStreamBuilder.juegeForStreamAndPattern(inputStream, dynamicPattern));
    }
    ...
    public PatternStream<T> inProcessingTimeJuege() {
        return new PatternStream<>(builder.inProcessingTimeJuege());
    }
    ...
    public PatternStream<T> inEventTimeJuege() {
        return new PatternStream<>(builder.inEventTimeJuege());
    }
